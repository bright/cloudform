...
export interface LaunchSpecificationsProperties {
...
export default class LaunchSpecifications extends ResourceBase {
    constructor(properties: LaunchSpecificationsProperties, dependsOn?: Value<string>);
}
