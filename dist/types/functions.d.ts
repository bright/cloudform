...
export declare function Join(delimiter: Value<string>, values: List<any>): CFFunction;
export declare function Select(index: Value<number>, listOfObjects: List<any>): CFFunction;
