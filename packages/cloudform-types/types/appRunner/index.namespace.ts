...
import AutoScalingConfiguration_ from './autoScalingConfiguration'
...
import VpcIngressConnection_ from './vpcIngressConnection' 

export namespace AppRunner {
  export const AutoScalingConfiguration = AutoScalingConfiguration_
  ...
  export const VpcIngressConnection = VpcIngressConnection_

  export type AutoScalingConfiguration = AutoScalingConfiguration_
  ...
  export type VpcIngressConnection = VpcIngressConnection_
}
