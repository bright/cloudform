...
export namespace AutoScaling {
  ...
  export type AutoScalingGroup = AutoScalingGroup_
  export type LaunchConfiguration = LaunchConfiguration_
  export type LifecycleHook = LifecycleHook_
  export type ScalingPolicy = ScalingPolicy_
  export type ScheduledAction = ScheduledAction_
  export type WarmPool = WarmPool_
}
