...
import DataRepositoryAssociation_ from './dataRepositoryAssociation'
...
export namespace FSx {
  export const DataRepositoryAssociation = DataRepositoryAssociation_
  ...
  export type DataRepositoryAssociation = DataRepositoryAssociation_
