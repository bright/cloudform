...
exports.TransformationConfiguration = exports.PublicAccessBlockConfiguration = exports.ObjectLambdaConfiguration = exports.ContentTransformation = exports.AwsLambda = exports.Alias = void 0;
...
exports.ContentTransformation = ContentTransformation;
...
class AccessPoint extends resource_1.ResourceBase {
    constructor(properties) {
        super('AWS::S3ObjectLambda::AccessPoint', properties);
    }
}
exports.default = AccessPoint;
AccessPoint.Alias = Alias;
AccessPoint.AwsLambda = AwsLambda;
AccessPoint.ContentTransformation = ContentTransformation;
AccessPoint.ObjectLambdaConfiguration = ObjectLambdaConfiguration;
