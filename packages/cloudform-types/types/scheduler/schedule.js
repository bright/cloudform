...
class Schedule extends resource_1.ResourceBase {
    constructor(properties) {
        super('AWS::Scheduler::Schedule', properties);
    }
}
exports.default = Schedule;
Schedule.AwsVpcConfiguration = AwsVpcConfiguration;
Schedule.CapacityProviderStrategyItem = CapacityProviderStrategyItem;
Schedule.DeadLetterConfig = DeadLetterConfig;
Schedule.EcsParameters = EcsParameters;
Schedule.EventBridgeParameters = EventBridgeParameters;
Schedule.FlexibleTimeWindow = FlexibleTimeWindow;
Schedule.KinesisParameters = KinesisParameters;
Schedule.NetworkConfiguration = NetworkConfiguration;
Schedule.PlacementConstraint = PlacementConstraint;
Schedule.PlacementStrategy = PlacementStrategy;
Schedule.RetryPolicy = RetryPolicy;
Schedule.SageMakerPipelineParameter = SageMakerPipelineParameter;
Schedule.SageMakerPipelineParameters = SageMakerPipelineParameters;
Schedule.SqsParameters = SqsParameters;
