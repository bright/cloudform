...
exports.default = {
    PortfolioShare: portfolioShare_1.default,
    TagOptionAssociation: tagOptionAssociation_1.default,
    LaunchTemplateConstraint: launchTemplateConstraint_1.default,
    TagOption: tagOption_1.default,
    PortfolioPrincipalAssociation: portfolioPrincipalAssociation_1.default,
    LaunchRoleConstraint: launchRoleConstraint_1.default,
    CloudFormationProvisionedProduct: cloudFormationProvisionedProduct_1.default,
    CloudFormationProduct: cloudFormationProduct_1.default,
    PortfolioProductAssociation: portfolioProductAssociation_1.default,
    Portfolio: portfolio_1.default,
    AcceptedPortfolioShare: acceptedPortfolioShare_1.default,
    LaunchNotificationConstraint: launchNotificationConstraint_1.default
};
