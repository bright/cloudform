...
export namespace SSM {
  ...
  export type PatchBaseline = PatchBaseline_
  export type MaintenanceWindowTarget = MaintenanceWindowTarget_
  export type MaintenanceWindowTask = MaintenanceWindowTask_
  export type Document = Document_
  export type MaintenanceWindow = MaintenanceWindow_
  export type Parameter = Parameter_
  export type ResourceDataSync = ResourceDataSync_
  export type Association = Association_
}
