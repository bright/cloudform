...
export type AliasAttributes = "*" | "phone_number" | "email" | "preferred_username"
export type AutoVerifiedAttributes = "*" | "phone_number" | "email"
export type MfaConfiguration = "*" | "OFF" | "ON" | "OPTIONAL"
