...
export interface SecurityGroupIngresProperties {
...
export default class SecurityGroupIngres extends ResourceBase {
    constructor(properties: SecurityGroupIngresProperties, dependsOn?: Value<string>) {
        super('AWS::EC2::SecurityGroupIngres', properties, dependsOn)
    }
}